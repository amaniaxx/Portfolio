...
import { Gamepad, Trophy, Play } from 'lucide-react';
...
const ChessPlaying = () => {
  ...
  const handlePlayWithMeClick = () => {
    window.open('https://www.chess.com/member/amaniaxx', '_blank'); 
  };
  ...
  return (
    <div 
      ...
      className="w-full"
      role="region"
      aria-label="Chess Playing Section"
    >
      <div className={`transition-all duration-1000 ${isVisible ? 'animate-slide-in-up' : 'opacity-0 translate-y-10'}`}>
        <Card className="glass-effect hover:border-white/50 transition-all duration-500 flex flex-col p-6 rounded-2xl group bg-gradient-to-br from-gray-900/95 to-gray-800/95 border-none relative overflow-hidden backdrop-blur-xl">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 via-transparent to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700" aria-hidden="true"></div>
          
          {/* Animated border effect */}
          <div className="absolute inset-0 rounded-2xl p-[1px] bg-gradient-to-br from-purple-500/30 to-blue-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700" aria-hidden="true">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-blue-500/10 animate-gradient-shift"></div>
          </div>

          {/* Subtle pattern overlay */}
          <div className="absolute inset-0 opacity-[0.02] group-hover:opacity-[0.03] transition-opacity duration-700" aria-hidden="true">
          ...
          <CardHeader className="flex flex-row items-center space-y-0 pb-6 relative z-10">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 flex items-center justify-center group-hover:from-purple-500/20 group-hover:to-blue-500/20 transition-all duration-700 shadow-lg shadow-purple-500/5 group-hover:shadow-purple-500/10" aria-hidden="true">
          ...
          <CardContent className="flex-1 flex flex-col justify-between relative z-10 p-6">
            <div className="flex items-center mb-6 space-x-6">
              <div className="w-32 h-32 flex-shrink-0 rounded-lg overflow-hidden glass-effect-strong group-hover:shadow-lg group-hover:shadow-purple-500/10 transition-all duration-700 hover:border hover:border-purple-500/30" aria-hidden="true">
                <OptimizedImage 
                  src="/chess.png" 
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-yellow-500/80" aria-hidden="true" />
            ...
            <div className="mt-auto">
              <Button 
                ...
                aria-label="Play chess with me on Chess.com"
              >
                <Play className="mr-2 h-6 w-6 group-hover:scale-110 transition-transform duration-500" aria-hidden="true" />
                Play with Me
              </Button>
            </div>
          </CardContent>

                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs sm:text-sm">aman.awasthi@email.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs sm:text-sm">+91 98765 43210</p>
                      </div>
                    </div>
                ...
                <CardContent className="p-6 sm:p-8">
                  ...
                  <div className="flex gap-3 sm:gap-4">
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="w-10 h-10 sm:w-12 sm:h-12 glass-effect hover:bg-primary/10 hover:text-primary transition-all duration-300"
                    >
                    ...
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="w-10 h-10 sm:w-12 sm:h-12 glass-effect hover:bg-blue-600/10 hover:text-blue-600 transition-all duration-300"
                    >
